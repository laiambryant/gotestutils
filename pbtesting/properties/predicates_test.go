...
func TestIntProperties(t *testing.T) {
	...
	assertProp(t, IntInSet{Values: []int64{1, 2, 3}}, 4, false)
	assertProp(t, IntNotInSet{Values: []int64{1, 2, 3}}, 2, false)
	assertProp(t, IntNotInSet{Values: []int64{1, 2, 3}}, 4, true)
...
func TestUintProperties(t *testing.T) {
	...
	assertProp(t, UintRange{Min: 3, Max: 5}, uint(2), false)
	...
	assertProp(t, UintMultipleOf{K: 4}, uint(9), false)
	assertProp(t, UintInSet{Values: []uint64{1, 2, 3}}, uint(2), true)
	assertProp(t, UintInSet{Values: []uint64{1, 2, 3}}, uint(4), false)
	assertProp(t, UintNotInSet{Values: []uint64{1, 2, 3}}, uint(2), false)
	assertProp(t, UintNotInSet{Values: []uint64{1, 2, 3}}, uint(4), true)
	assertProp(t, UintCanIncludeZero{Allowed: false}, uint(0), false)
	assertProp(t, UintCanIncludeZero{Allowed: false}, uint(1), true)
}

func TestFloatProperties(t *testing.T) {
	assertProp(t, FloatMin{Min: 1.5}, 1.4, false)
...
func TestComplexProperties(t *testing.T) {
	...
	assertProp(t, ComplexImagRange{Min: -1, Max: 1}, complex(0, 1.5), false)
	assertProp(t, ComplexImagRange{Min: -1, Max: 1}, complex(0, -0.5), true)
